...
namespace Leap.Unity.Drawing {
  ...
  public class StrokePointStreamSkippingFilter : StreamSkippingFilter<StrokePoint> {

    protected override void ShouldSkip(StrokePoint data,
                                       StrokePoint lastOutputData,
                                       List<StrokePoint> skippedSoFar,
                                       out bool shouldSkip,
                                       out bool shouldRememberSkip,
                                       out Maybe<StrokePoint> outputOverride) {
      shouldSkip = true;
