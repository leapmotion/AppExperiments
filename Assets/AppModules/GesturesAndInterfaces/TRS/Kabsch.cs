...
namespace Leap.Unity {
  ...
  public class KabschSolver {
    ...
    public Matrix4x4 SolveKabsch(Vector3[] inPoints, Vector4[] refPoints, bool solveRotation = true, bool solveScale = false) {
      ...
      if (solveRotation) {
        extractRotation(TransposeMultSubtract(inPoints, refPoints, inCentroid, refCentroid, _dataCovariance), ref _optimalRotation);
      }
	...
	internal static class KabschExtensions {
