...
namespace Leap.Unity.Apps.Paint4 {
  ...
  public class BuildingPrimitive : MonoBehaviour, IRuntimeGizmoComponent {
    ...
    private void onGraspEnd() {
      if (anchorControl.TryAttachToNearestAnchor()) {
        this.transform.parent = anchorControl.anchor.transform;
      }
    ...
    private void smoothGraspedMovement(Vector3 preSolvedPos, Quaternion preSolvedRot, Vector3 solvedPos, Quaternion solvedRot, List<InteractionController> _) {
